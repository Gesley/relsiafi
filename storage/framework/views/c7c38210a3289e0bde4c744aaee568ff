<form class="form-horizontal" name="CreateExtracaoForm">
    <fieldset>
        <legend>Adicionar Extração</legend>
        ...
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
                ...
                <button type="submit" class="btn btn-primary" ng-disabled="CreateExtracaoForm.$invalid" ng-click="create()">Salvar</button>
            </div>
        </div>
    </fieldset>
</form>
